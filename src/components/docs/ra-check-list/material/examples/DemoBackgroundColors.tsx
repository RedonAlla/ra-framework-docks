    ...
    return (
      <div className='example-div demo-column'>
        <div className='demo-row'>
          <CheckList material label='Background Color' backgroundColor="crimson" value={this.state.nameValues} onValueChange={this.handleNameValueChange}>
            <Check value='crimson' label='crimson' />
            <Check value='blue' label='blue' />
            <Check value='red' label='red' />
          </CheckList>

          <CheckList material label='Background Color' backgroundColor="rgb(237, 20, 61)" value={this.state.rgbValues} onValueChange={this.handleRgbValueChange}>
        ...
        <div className='demo-row'>
          <CheckList material label='Background Color' backgroundColor="#ed143d" value={this.state.hexValues} onValueChange={this.handleHexValueChange}>
            <Check value='#ed143d' label='#ed143d' />
            <Check value='#ce04d1' label='#ce04d1' />
            <Check value='#343deb' label='#343deb' />
          </CheckList>

          <CheckList material label='Background Color' backgroundColor="rgba(237, 20, 61, 0.5)" value={this.state.rgbaValues} onValueChange={this.handleRgbaValueChange}>

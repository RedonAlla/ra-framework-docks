  ...
  public render() {
    return (
      <div className='example-block demo-column'>
        <CheckList material label='Object Values' valueField={'id'} value={this.state.valueObject} onValueChange={this.handleValueObjectChange}>
        ...
        <CheckList material label='String values' value={this.state.valueString} onValueChange={this.handleValueStringChange}>
        ...
        <CheckList material label='Number values' value={this.state.valueNumber} onValueChange={this.handleValueNumberChange}>

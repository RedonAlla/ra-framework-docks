      ...
      <div className='example-block demo-column'>
        ...
        <div className='demo-row'>
          ...
          <CheckList material label='Color' color="rgba(237, 20, 61, 0.5)" value={this.state.custom} onValueChange={this.handleCustomChange}>
            <Check value='custom' label='primary' material label='Color' color='primary' />
            <Check value='custom1' label='info' material label='Color' color='info' />
            <Check value='custom2' label='success' material label='Color' color='success' />
          </CheckList>
        </div>
      </div>
    );

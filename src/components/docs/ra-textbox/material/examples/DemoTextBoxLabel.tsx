    ...
    return (
      <div className='example-block'>
        ...
        <div className='column'>
          <TextBox material label='Label' placeholder='Input with text label' label="Label" />
        </div>

        <div className='column'>
          <TextBox material label='Label' placeholder='Input with custom element as label' label={<Label />} />
        </div>

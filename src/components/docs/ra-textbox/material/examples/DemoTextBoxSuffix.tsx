    ...
    return (
      <div className='example-block'>
        ...
        <div className='column'>
          <TextBox material label='Label' placeholder='Input with icon prefix' suffix="star" />
        </div>

        <div className='column'>
          <TextBox material label='Label' placeholder='Input with custom element as prefix' suffix={<Prefix />} />
        </div>

...
**[BaseTheme](/docs/getting-gtarted/setup-ra-theme-provider#basetheme)**  object is where you define your application's color palette.

If you need to customize the default theme to match your design requirements you should override **BaseTheme** from `ra-theme-context`.
